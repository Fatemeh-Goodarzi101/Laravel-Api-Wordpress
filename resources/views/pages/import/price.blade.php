    ...
    <div class="card mt-5" style="width: 50%; margin: auto;box-shadow: 1px 1px 1px #00000020;">
        <div class="card-body">
            <div class="container-fluid w-75">
                <form class="row g-3" method="post" enctype="multipart/form-data" action="{{ route('importPriceFile') }}">
                    {{ csrf_field() }}
                    <div class="col-12">
                        <label for="formFile" class="form-label">آپلود فایل تغییر قیمت عادی و فروش ویژه محصولات:</label>
